...
class FlightCard extends StatelessWidget {
  final FlightItem data;
  final int index;

  const FlightCard({Key? key, required this.data, required this.index})
      : super(key: key);
                    ...
                    children: [
                      TextUtil(
                        ...
                        overflow: TextOverflow
                            .ellipsis, // Provide the appropriate enum value here
                      ),
                      const SizedBox(height: 5),
                      TextUtil(
                        ...
                        weight: true,
                        overflow: TextOverflow
                            .ellipsis, // or TextOverflow.clip, or TextOverflow.fade
                      )
                    ],
                  )
                ],
